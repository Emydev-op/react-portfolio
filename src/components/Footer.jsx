  ...
  return (
    <div className="md:px-10 px-7 mt-24">
      <div className="text-white opacity-50 flex flex-col md:flex-row justify-between items-center my-5">
        <p>@ Copyright 2023 | Osegbo Emeka</p>
        ...
        <p className="hidden sm:block">Designed by @emydev</p>
      </div>
      {/* social media */}
      <div className="flex mb-5 justify-center md:justify-start ">
        <a
          href="https://www.linkedin.com/in/chukwuemeka-osegbo-733721196"
          target="_blank"
          rel="noreferrer"
        >
        ...
        <a
          className="ml-4"
          href="https://www.instagram.com/casual_emy"
          target="_blank"
          rel="noreferrer"
        >
        ...
        <a
          className="ml-4"
          href="https://github.com/Emydev-op"
          target="_blank"
          rel="noreferrer"
        >
