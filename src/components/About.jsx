...
const About = () => {
  const skills = [
    ...
    { name: "FRONTEND DEVELOPMENT", image: "/src/assets/icons/code.png" },
  ...
  return (
    <div className="md:px-10 px-7 sm:-mt-24 mt-10" id="about">
      ...
      <p className="my-3 text-white md:w-2/3 leading-[2]">
        ...
        designer. I have honed my skills in Web Development and advance i have
        core understanding of advance UI design principles. Here are the major
        skiills i have.
      </p>
